...
const Pages: React.FC = () => {
  ...
  return (
    <main className='bg-[#151415] h-[100vh]'>
      <Navbar/>
      <section className=''>
        <div className='bg-gradient-to-bl from-green-500 to-lime-500 p-10 md:p-20 rounded-3xl flex flex-col items-center justify-center m-5 md:m-32 text-center'>
          ...
          <button className='bg-black rounded-xl text-white px-10 py-2 mt-3'>
